...
else if (randomNumber>50)
{
    ...
    switch (randomNumber){
        case (a):  console.log("randomNumber меньше 20");
        break;
        case (b):   console.log("randomNumber больше 50");
        break;
        case (c):  console.log("randomNumber больше 20, и меньше 50"); ;
        break;
}
